  ...
  return (
    <div id='contact' className='w-full px-[12%] py-10 mt-24 scroll-mt-20 bg-[url("/header-bg-color.jpg")] bg-no-repeat bg-center bg-[length:90%_auto]'>
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            <button type='submit' className='py-2 px-5 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500'>Submit <Image src={assets.right_arrow_white} alt='submit' className='w-4' /></button>
